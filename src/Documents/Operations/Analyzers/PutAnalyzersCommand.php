...
class PutAnalyzersCommand extends VoidRavenCommand implements RaftCommandInterface
{
    ...
    {
        return $serverNode->getUrl() . "/databases/" . $serverNode->getDatabase() . "/admin/analyzers";
    }
