...
class StopIndexCommand extends VoidRavenCommand
{
    ...
    {
        return $serverNode->getUrl() . "/databases/" . $serverNode->getDatabase() . "/admin/indexes/stop?name=" . UrlUtils::escapeDataString($this->indexName);
    }
