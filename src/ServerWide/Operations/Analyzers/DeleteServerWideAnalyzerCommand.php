...
class DeleteServerWideAnalyzerCommand extends VoidRavenCommand implements RaftCommandInterface
{
    ...
    {
        return $serverNode->getUrl() . "/admin/analyzers?name=" . urlEncode($this->analyzerName);
    }
