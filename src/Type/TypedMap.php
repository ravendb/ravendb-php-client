...
class TypedMap extends \ArrayObject implements \JsonSerializable, DenormalizableInterface
{
     ...
     */
    public function addItemFromData(string $key, array $data): void
    {
