...
//    public function canConfigureTimeSeries(): void {
...
//
//    @Test
//    public function notValidConfigureShouldThrow(): void {
//        try (IDocumentStore store = getDocumentStore()) {
...
//    }
    ...
    public function testCanExecuteSimpleRollup(): void
    {
        ...
        try {
            ...
            $config->setCollections(TimeSeriesCollectionConfigurationArray::fromArray(["Users" => $collectionConfig]));
...
//    @Test
//    @DisabledOnPullRequest
//    public function canConfigureTimeSeries2(): void {
//        try (IDocumentStore store = getDocumentStore()) {
...
//    @Test
//    @DisabledOnPullRequest
//    public function canConfigureTimeSeries3(): void {
//        try (IDocumentStore store = getDocumentStore()) {
